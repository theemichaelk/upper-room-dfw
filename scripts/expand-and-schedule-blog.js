#!/usr/bin/env node
/**
 * Expand existing blog posts to 1000+ words of practical local guidance and
 * schedule 25 weekly drip posts. Each post: 2 images + 3 siloed links
 * (homepage, internal Upper Room page, authoritative external).
 * Avoid marketing jargon in reader-facing copy.
 *
...
/** Core long-form sections reused with local injection — plain, pastoral language */
function localContext(city, primaryKw) {
 return [
...
function quickBrief(topic) {
 ...
 p(`Keep this short list handy while you explore options related to ${topic}.`),
 ul([
...
function buildContent(spec, prefix = '../') {
 ...
 localContext(city, primaryKw),
 quickBrief(title.toLowerCase()),
 ...
 p(
 `<strong>Bottom line:</strong> Families choose churches through usefulness, accuracy, and local clarity—not hype. Use Upper Room DFW as your research hub, visit with intention, and keep your own listing current if you serve a church in Texas.`
 ),
 ].join('');
...
const EXISTING_SPECS = [
 ...
 excerpt: 'A 1,000+ word local family guide for Dallas–Fort Worth families comparing worship, youth programs, bilingual services, and outreach using the Upper Room DFW church directory using the Upper Room DFW church directory.',
 ...
 p(
 'Our directory tracks 100+ verified churches across North Texas cities with program tags—youth, family, outreach, bilingual—and GMB-aligned signals where available. That structure supports both classic visibility and generative answers that need entities and cities, not vague “great church” claims.',
 ...
 excerpt: 'Plano and Collin County parents prioritize kids programs, safety, and community. A long-form local guide to family-friendly churches.',
 city: 'Plano',
 ...
 excerpt: 'From downtown Fort Worth to Keller and Arlington, a practical local guide to contemporary worship communities—live bands, practical teaching, and how to compare listings for churches in DFW’s western half.',
 city: 'Fort Worth',
 ...
 excerpt: 'Youth nights, summer camps, and mentorship across Dallas–Fort Worth—and what parents should ask before enrolling teens.',
 city: 'DFW Metroplex',
 ...
 excerpt: 'Summer faith events across North Texas—conferences, outdoor worship, family festivals—plus how to stay updated on festivals, revivals, and outreach.',
 city: 'DFW Metroplex',
 ...
 excerpt: 'Sunday is the front door; small groups build lasting friendships. A practical guide to home groups, Bible studies, and community across Plano, Dallas, Fort Worth, and suburbs.',
 city: 'North Texas',
 ...
 title: 'Register Your Church on Upper Room DFW: Why Local Listings Matter',
 ...
 city: 'DFW Metroplex',
 keywords: ['list church Dallas', 'register church DFW', 'best directory in Texas', 'churches in Texas', 'Upper Room DFW'],
 ...
 'Clear public page on upperroomdfw.com',
 ...
 'A complete listing pairs well with a healthy Google Business Profile: consistent names, categories, hours, and photos. Treat both as pastoral infrastructure.'
 ),
 ].join(''),
 },
 {
...
const NEW_SPECS = [
 ...
 excerpt: 'Map packs show distance; fit needs more. A practical guide to searching “churches near me” across Dallas–Fort Worth with Upper Room DFW filters and visit strategy.',
 city: 'Dallas-Fort Worth',
 ...
 ul(['Add your suburb name', 'Add youth, bilingual, or outreach', 'Add worship style notes', 'Compare two campuses in one weekend']),
 ].join(''),
 },
 {
 slug: 'best-church-directory-in-texas-dfw',
 title: 'Best Church Directory in Texas for DFW Families: What to Look For',
 excerpt: 'Not every directory is equal. Criteria for choosing the best church directory in Texas—coverage, verification, clear pages, and member tools—centered on Upper Room DFW.',
 city: 'Texas',
 ...
 ol(['Metro-wide coverage, not one zip code', 'Editable member profiles', 'Program tags seekers actually use', 'Human verification, not spam dumps']),
 ...
 excerpt: 'Statewide brand searches differ from DFW neighborhood intent. How statewide searches differ from neighborhood choices—and how to use both wisely.',
 city: 'Texas',
 ...
 angleSections: (prefix) => [
 h2('Platform pillars'),
 ul(['Public directory search', 'Church detail pages', 'Registration and claims', 'Member portal and billing tiers', 'Educational blog for families and pastors']),
 ...
 excerpt: 'Arlington sits in the DFW heart. Find churches near entertainment districts, universities, and family suburbs with Upper Room filters and practical shortlist tips.',
 city: 'Arlington',
 ...
 title: 'Garland & Mesquite Churches: A Local Guide for East DFW',
 excerpt: 'East DFW seekers need accurate listings and bilingual options. A practical guide for Garland and Mesquite church discovery.',
 city: 'Garland',
 ...
 title: 'Google Business Profile + Church Directory: Working Together for Local Discovery',
 ...
 city: 'Dallas-Fort Worth',
 keywords: ['Google church listing', 'churches near me', 'Upper Room DFW', 'churches in Texas'],
 ...
 excerpt: 'Operational details win trust. A practical guide covering first impressions seekers notice when searching churches near me.',
 city: 'Dallas-Fort Worth',
 ...
 title: 'How to List Your Church in Texas (DFW Playbook)',
 ...
 city: 'Texas',
 keywords: ['list church visibility', 'church directory', 'best directory in Texas', 'Upper Room DFW', 'churches in Texas', 'churches near me'],
 primaryKw: 'list your church in Texas',
 angleSections: (prefix) => [
 ...
 city: 'Dallas-Fort Worth',
 keywords: ['church reviews DFW', 'churches near me', 'church reputation', 'church directory', 'Upper Room DFW', 'local discovery churches'],
